...
try {
    ...
    $mail->Password   = 'NNo00081670%#';                               //SMTP password AJYTHo6988mcxrABq%#
    ...
    $mail->Body    = 'Hola, le saludamos de Smile Design, le enviamos este correo para corroborar su correo electrónico. 
