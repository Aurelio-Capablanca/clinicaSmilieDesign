        ...
        switch ($_GET['action']) {
            ...
            case 'delete': 
                ...
                case 'readOnes':
                    ...
                    break;
                    case 'readTratamientosPorcentajes':
                        if ($result['dataset'] = $producto->readTratamientosPorcentajes()) {
                            $result['status'] = 1;
                        } else {
                            if (Database::getException()) {
                                $result['exception'] = Database::getException();
                    ...
                    break;
                    case 'readTopTratamientos':
                        if ($result['dataset'] = $producto->readTopTratamientos()) {
                            $result['status'] = 1;
                        } else {
                            if (Database::getException()) {
                                $result['exception'] = Database::getException();
