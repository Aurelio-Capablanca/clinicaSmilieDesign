...
Dashboard_Page::headerTemplate('Verificar Contraseña');
?>   
<br>
<div class="container">
    <div class="row" >
        ...
        <form method="post"  id="mail-form">
            ...
            <div class="input-field col s12 m6 offset-m3">
                ...
                <input id="correo_enviar" type="email" name="correo_enviar" class="validate" oncopy="return false" oncut="return false" onpaste="return false" required autocomplete="off"/>
                <label for="correo_enviar">Correo Empleado</label>
            </div>           
...
Dashboard_Page::footerTemplate('validarcorreo.js');
?>