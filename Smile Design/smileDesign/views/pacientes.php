...
<div class="container">
    ...
    <div id="show-preguntas-modal" class="modal">
        <div class="modal-content center-align">
            <h4> </h4>
            <h4 id="modal-preguntas-title" class="center-align"></h4>
            <form method="post" id="show-p-form">
                <input class="hide" type="number" id="id_pacientepr" name="id_pacientepr" />
                <input class="hide" type="number" id="id_pacienteprs" name="id_pacienteprs" />
                <input id="nombre_pacientepr" type="text" name="nombre_pacientepr" class="hide" />
                <div class="row">
                    <table class="responsive-table highlight">
                        <thead>
                            <tr>
...
<div id="save-modal" class="modal">
    <div class="modal-content center-align">
        ...
        <h4 id="modals-title" class="center-align"></h4>
...
<div id="save-preguntas-modal" class="modal">
    <div class="modal-content center-align">
        ...
        <form method="post" id="save-preguntas-form">
            ...
            <input class="hide" type="number" id="id_pacientesree" name="id_pacientesree" />
            <input class="hide" type="number" id="id_pacientesU" name="id_pacientesU" />
            <div class="row">
