  ...
  <div class="row">
    ...
    <div class="section container">
        ...
        <div class="row card-panel" style="text-align:center;">
            ...
            <a onclick="a()" class="waves-effect waves-light btn-small"><i class="material-icons left">rotate_left</i>Cargar grafica</a>        
    ...
    <div class="row card-panel" style="text-align:center;">
        ...
        <div class="col s8">
            <h5>Tipo de tratamiento más solicitado (top 3)</h5>
