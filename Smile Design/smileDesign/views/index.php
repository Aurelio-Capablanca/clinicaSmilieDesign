    ...
    <div class="row">
        ...
        <input id="dias" type="text" name="dias" class="hide" />
            ...
            <div class="input-field col s12 m6 offset-m3">
                ...
                <input id="usuario" type="text" name="usuario" class="validate" oncopy="return false" oncut="return false" onpaste="return false" required/>
                <label for="usuario">Alias</label>
            </div>
            <div class="input-field col s12 m6 offset-m3">
                <i class="material-icons prefix">security</i>
                <input id="clave" type="password" name="clave" class="validate" oncopy="return false" oncut="return false" onpaste="return false" required/>
