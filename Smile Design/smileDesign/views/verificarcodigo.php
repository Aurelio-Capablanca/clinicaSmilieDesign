...
<div class="container">
    <div class="row" >    
        ...
        <form method="post" id="codigo-form">
                ...
                <input id="correo1" type="text" name="correo1" class="hide"/>
        ...
        <form method="post" id="pass-form">                
                <input id="correo" type="text" name="correosenvio" class="hide"/>
...
Dashboard_Page::footerTemplate('verificarcodigo.js');
?>